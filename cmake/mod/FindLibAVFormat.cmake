...
find_path (LIBAVFORMAT_INCLUDE_DIR libavformat/avformat.h ${LIBAVFORMAT_INCLUDE_DIRS} ${WIN64_LIBAV_DIR}/include)
list (APPEND LIBAVFORMAT_INCLUDE_DIRS ${LIBAVFORMAT_INCLUDE_DIR})
find_library (LIBAVFORMAT_LIBRARY NAMES avformat HINTS ${LIBAVFORMAT_LIBDIR} ${LIBAVFORMAT_LIBRARY_DIRS} ${WIN64_LIBAV_DIR}/bin)
