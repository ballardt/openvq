...
#
# Based on "FindLibAVUtil.cmake from the Bluecherry project
#
...
find_path (LIBSWSCALE_INCLUDE_DIR libswscale/swscale.h ${LIBSWSCALE_INCLUDE_DIRS} ${WIN64_LIBAV_DIR}/include)
list (APPEND LIBSWSCALE_INCLUDE_DIRS ${LIBSWSCALE_INCLUDE_DIR})
find_library (LIBSWSCALE_LIBRARY NAMES swscale HINTS ${LIBSWSCALE_LIBDIR} ${LIBSWSCALE_LIBRARY_DIRS} ${WIN64_LIBAV_DIR}/bin)
