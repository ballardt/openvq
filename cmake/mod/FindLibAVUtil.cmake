...
find_path (LIBAVUTIL_INCLUDE_DIR libavutil/avutil.h ${LIBAVUTIL_INCLUDE_DIRS} ${WIN64_LIBAV_DIR}/include)
list (APPEND LIBAVUTIL_INCLUDE_DIRS ${LIBAVUTIL_INCLUDE_DIR})
find_library (LIBAVUTIL_LIBRARY NAMES avutil HINTS ${LIBAVUTIL_LIBDIR} ${LIBAVUTIL_LIBRARY_DIRS} ${WIN64_LIBAV_DIR}/bin)
