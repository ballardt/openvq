...
find_path (LIBAVCODEC_INCLUDE_DIR libavcodec/avcodec.h PATHS ${LIBAVCODEC_INCLUDE_DIRS} ${WIN64_LIBAV_DIR}/include)
list (APPEND LIBAVCODEC_INCLUDE_DIRS ${LIBAVCODEC_INCLUDE_DIR})
find_library (LIBAVCODEC_LIBRARY NAMES avcodec HINTS ${LIBAVCODEC_LIBDIR} ${LIBAVCODEC_LIBRARY_DIRS} ${WIN64_LIBAV_DIR}/bin)
